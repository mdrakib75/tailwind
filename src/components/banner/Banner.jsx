...
const Banner = () => {
  return (
     <div className='bg-[url(/banner.png)] py-[70px] lg:py-[200px] bg-no-repeat bg-center bg-cover relative z-[1] after:absolute after:left-0 after:top-0 after:content-[""] after:h-[100%] after:w-full after:bg-[rgba(27,26,26,0.5)] after:z-[-1]'>
      <Container>
